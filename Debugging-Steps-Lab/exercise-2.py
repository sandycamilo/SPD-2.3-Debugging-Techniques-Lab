...
Expected - False & True
Actual - False, False 
Line causing error- 6 ~ when it moved to answer 2. 
The if statement list_of_nums[i+1] == list_of_nums[i] + 1 does
not satisfy the first number on the list and returns false immediately. 
"""
