...
def isWinner(bo, le):
  """Given a board and a player’s letter, it returns True if player has won.
      Uses bo for the board and le for letter."""
...
def getBoardCopy(board):
  """Makes a duplicate of the board list and return it."""
  dupeBoard = []
...
def chooseRandomMoveFromList(board, movesList):
  """Returns valid move from the passed list on passed board and 
